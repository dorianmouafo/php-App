...
function calendarpopup($iddiv,$form,$langue,$format) {
	...
	print "cal18.setCssPrefix('TEST');";
        ...
        print "</script>\n";
        print "<A HREF='#' onClick=\"cal18.select($form,'anchor18$iddiv','dd/MM/yyyy'); return false;\" return false;\" NAME='anchor18$iddiv' ID='anchor18$iddiv'><img src='calendar.gif' border='0' align='center'></A>\n";
        print "<!-- ================================================================================== -->\n";
}
...
//	print "cal$iddiv.setYearSelectStartOffset(50);\n";
	...
	print "</script>\n";
	print "<a href='#' onClick=\"cal$iddiv.select($form,'anchor18$iddiv','dd/MM/yyyy'); return false;\" return false;\" NAME='anchor18$iddiv' ID='anchor18$iddiv'><img src='calendar.gif' border='0' align='center'></A>\n";
	print "<!-- ================================================================================== -->\n";
	print "<div ID='$iddiv' STYLE='position:absolute;visibility:hidden;background-color:white;layer-background-color:white;'></div>\n";
}
