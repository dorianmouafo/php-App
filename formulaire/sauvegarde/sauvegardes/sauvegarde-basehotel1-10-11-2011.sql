...
CREATE TABLE `acces_bouton` (
  ...
  CONSTRAINT `acces_bouton_ibfk_1` FOREIGN KEY (`CODE_PRIVILEGE`) REFERENCES `privilege` (`CODE_PRIVILEGE`),
  CONSTRAINT `acces_bouton_ibfk_2` FOREIGN KEY (`CODE_BOUTON`) REFERENCES `bouton` (`CODE_BOUTON`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `acces_element` (
  ...
  CONSTRAINT `acces_element_ibfk_1` FOREIGN KEY (`CODE_PRIVILEGE`) REFERENCES `privilege` (`CODE_PRIVILEGE`),
  CONSTRAINT `acces_element_ibfk_2` FOREIGN KEY (`CODE_ELEMENT`) REFERENCES `element` (`CODE_ELEMENT`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `acces_sm` (
  ...
  CONSTRAINT `acces_sm_ibfk_1` FOREIGN KEY (`CODE_PRIVILEGE`) REFERENCES `privilege` (`CODE_PRIVILEGE`),
  CONSTRAINT `acces_sm_ibfk_2` FOREIGN KEY (`CODE_SM`) REFERENCES `sous_menu` (`CODE_SM`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `acces_ssm` (
  ...
  CONSTRAINT `acces_ssm_ibfk_1` FOREIGN KEY (`CODE_PRIVILEGE`) REFERENCES `privilege` (`CODE_PRIVILEGE`),
  CONSTRAINT `acces_ssm_ibfk_2` FOREIGN KEY (`CODE_SSM`) REFERENCES `sous_sous_menu` (`CODE_SSM`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('10','9','3','2011-11-07','2011-09-26','Juste occupée'),
('11','12','2','2011-10-15','2011-10-28','juste pour tester ma requette'),
('12','11','2','2011-10-17','0000-00-00','encore test'),
('13','14','3','2011-11-07','2011-10-28','test'),
('14','14','3','2011-11-07','2011-10-17','afaf'),
('15','14','3','2011-11-07','2011-11-02','afaf'),
('17','2','2','2011-11-01','2011-10-31',''),
('18','1','3','2011-11-07','2011-10-31',''),
('19','1','3','2011-11-07','2011-10-28',''),
('20','1','3','2011-11-07','2011-11-21',''),
('21','2','2','2011-11-01','2011-11-10','ras'),
('22','2','2','2011-11-01','2011-11-17','testons'),
('23','32','3','2011-11-10','2011-12-31','RAS'),
('24','12','1','2011-11-01','2011-11-30','jjjjjjj');
...
('95','4','8','1000','8000','2011-11-13'),
('95','7','3','1000','3000','2011-11-16'),
('86','1','2','1000','2000','2011-11-01'),
('86','1','2','1000','2000','2011-11-01'),
('95','9','1','3000','3000','2011-11-01'),
('76','1','1','1000','1000','2011-11-01'),
('76','1','2','1000','2000','2011-11-01'),
('76','6','1','2000','2000','2011-11-01'),
('86','6','10','2000','20000','2011-11-01');
...
('22','22','100','2011-11-01','2011-11-30'),
('23','23','2200','2011-11-07','2012-11-28'),
('24','24','10000','2011-11-01','2012-11-26');
...
('7','2011-11-08','14:42:53','a Imprimer une fiche client'),
('7','2011-11-08','14:43:04','a Imprimer une fiche client'),
('7','2011-11-08','15:26:46','Connexion a FS'),
('7','2011-11-08','15:56:32','Connexion a FS'),
('7','2011-11-09','08:19:15','Connexion a FS'),
('7','2011-11-09','08:45:26','Connexion a FS'),
('7','2011-11-09','09:36:05','Connexion a FS'),
('7','2011-11-09','09:54:49','Occuper un client'),
('7','2011-11-09','09:59:37','Occuper un client'),
('7','2011-11-09','13:39:45','Connexion a FS'),
('7','2011-11-09','14:44:33','Connexion a FS'),
('7','2011-11-09','14:45:55','Ajouter une consommation'),
('7','2011-11-09','14:51:02','Ajouter une consommation'),
('7','2011-11-09','14:51:40','Ajouter une consommation'),
('7','2011-11-09','14:54:11','Ajouter une consommation'),
('7','2011-11-09','14:54:40','Ajouter une consommation'),
('7','2011-11-09','14:55:07','Ajouter une consommation'),
('7','2011-11-09','15:12:03','Ajouter un client'),
('7','2011-11-09','15:14:50','Occuper un client'),
('7','2011-11-10','08:38:27','Connexion a FS'),
('7','2011-11-10','09:44:12','Ajouter une consommation'),
('7','2011-11-10','11:37:31','Connexion a FS'),
('7','2011-11-10','12:42:58','Connexion a FS'),
('7','2011-11-10','13:07:35','Connexion a FS');
...
('10','1','2','2011-11-09','14:10:12','2011-11-29','12:12:14','0','0','2'),
('11','14','7','2011-11-01','14:10:12','2011-11-22','12:12:14','0','0','3');
...
('7','100','12541','cni','2011-11-15','','Takam','Armance','2009-11-10','','cameroun','camerounaise','cameroun','yaounde','','99522','','secretaire','','','0','','','Garoua','cousierie','feminin');
...
CREATE TABLE `sous_sous_menu` (
  ...
  CONSTRAINT `sous_sous_menu_ibfk_1` FOREIGN KEY (`CODE_SM`) REFERENCES `sous_menu` (`CODE_SM`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Fichier : "sauvegarde-basehotel1-10-11-2011.sql", 49 table(s), 424 enregistrement(s)
-- Sauvegarde g&eacute;n&eacute;r&eacute;e par K20save v1.0 en 2.6548 s, date : 10-11-2011
--