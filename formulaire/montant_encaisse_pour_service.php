...
<?php
  ...
  ?>
                          <div class="art-post-inner art-article">
                                          <h2 class="art-postheader" style="text-align:center;">MONTANT DES SERVICES PAR P&Eacute;RIODE<a href="#" rel="bookmark" title="Permanent Link to this Post"></a> <a class="visited" href="#" rel="bookmark" title="Visited Hyperlink"></a> <a class="hovered" href="#" rel="bookmark" title="Hovered Hyperlink"></a></h2>
									   ...
									   $link=Connexion();
										...
										while($date_de_debut <= $date_de_fin){ 
										    ...
										    while($lecture=mysql_fetch_array($result3)){
											    ...
											    $montant_total_du_jour=recupere_montant_service_par_jour($code,$date_de_debut);echo $montant_total_du_jour;
											    print " <td> $montant_total_du_jour </td>";
												$montant_total_par_jour_pour_tous_les_services+=$montant_total_du_jour;
											}
											
											print "<td class='entete_tableau'>  ";
											print "<strong> $montant_total_par_jour_pour_tous_les_services </strong>";
											print "</td>";
										...
										while($lecture=mysql_fetch_array($result3)){
											...
											print "<td class='entete_tableau'>  ";
											print "<strong> $montant_total_du_service_pour_la_periode </strong>";
											print "</td>";
                          ...
                          <div class="art-post-inner art-article">&nbsp;D&eacute;finissez une p&eacute;riode<strong  style="text-align:center;" ></strong>
										  ...
										  <tr style="border:hidden">
												<form method="post" name="objet_oublie" action="montant_encaisse_pour_service.php?modif_code=<?php print $g_code; ?>" >
													<p align="center">
									...
									<input type="submit" name="btn" style="width:80px; height:30px" onClick="window.open('../etat/etat_montant_encaisse_pour_service.php','MONTANTS ENCAISSES POUR LES CHAMBRES','toolbar=yes,menubar=no,location=no,risizable=no,scrollbars=yes,status=no,height=800,width=1200')" value="Afficher"/>
