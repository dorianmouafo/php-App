...
$g_valeur_identite1=$g_code;
$g_valeur_identite=recupere_idclient_facturinstant($g_valeur_identite1);
}
?>
<body>
                                        <?php                                  
...
?>
 <strong>Client:</strong><input readonly id="client" type="text" value="<?php print $g_valeur_recup?>" size="80"/><input readonly id="identite" type="text" value="<?php print $g_valeur_identite?>" size="1"/>
