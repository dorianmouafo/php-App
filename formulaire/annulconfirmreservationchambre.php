...
<?php
 ...
 $g_date_annul1=dateFormBase($g_date_annul); 
	    if($v_global==Ajout){
			...
			modif_date_confirme_chambresate($confirm,$g_code,$g_date_confirme1);
			...
			modif_date_annul_chambresate($annul,$g_code,$g_date_annul1);
                          ...
                          <div class="art-post-inner art-article">
									   ...
									   require_once('../procedure_php/procedure_globale.php');
										...
										{  extract($lecture);
                                            ...
                                            print " <td><a href='annulconfirmreservationchambre.php?modif_code=$ID_RESEVATION'>".stripslashes(rechercher_nomclient_fromreservation_sans_table($ID_RESEVATION))."</a></td>";											 
											print " <td>".stripslashes(rechercher_recsenalibbatypechabmre_sans_table($CODE_TYPE_CHAMBRE))."</td>";
											print " <td>".stripslashes($ETAT_RESERV_CHAM)."</td>";
											print " <td>".stripslashes($DATE_CONFIRME)."</td>";
...
echo '<p class="pagination">' . pagination($page, $nb_pages) . '</p>';
                          ...
                          <div class="art-post-inner art-article">
										...
										<!-- formulaire -->
											<form method="post" name="cadre" action="annulconfirmreservationchambre.php?modif_code=<?php print $g_code;?>">
