...
header('location:../index.php');
    ...
    //include('decoupagebon/fichier_config.php');
?>
...
{
window.open("../documents/a_propos.php", "ouverture", "toolbar=no, status=no, scrollbars=no, resizable=no, width=400, height=500");
}
//-->
</SCRIPT>  
<SCRIPT LANGUAGE="JavaScript">
...
{
window.open("main_courante.php", "", "toolbar=yes, status=yes, scrollbars=yes, resizable=yes, width=1000, height=1000");
}
function ouverture1()
{
                	...
                	<ul class="art-menu">
						...
						<li>
							...
							<ul>
								...
								<li><a href="#">Montant en caiss&eacute;e</a>
								<ul>
									<li><a href="montant_encaisse_pour_chambre.php">Chambre</a></li>
									<li><a href="#">Service</a></li>
								</ul>
								</li>
								<li><a href="#">Main courante de R&eacute;ception</a></li>
						...
						<li>
							...
							<a href="enregistrementclient.php?deconnect=2"><span class="l"></span><span class="r"></span><span class="t">Deconnexion</span></a>
                		</li>
                              ...
                              <div class="art-block-body">
                                       <div class="art-blockheader">
                                          ...
                                          <div class="art-blockcontent">
                                              ...
                                              <div class="art-blockcontent-body">
													<ul>
                                                         <li><a href="factureclient.php" title="Facturation">Facturation Client Unique</a></li>
														 <br/>
                                                         <li><a href="" title="Facturation" >Facturation Instantan&eacute;e</a></li>
                                                    </ul>
                                          		<div class="cleared"></div>
                                              </div>
                                          </div>       
