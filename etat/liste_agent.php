...
<body>
<form>
<input type="submit" style="width:80px; height:23px"  name="btn"  class="btn1"  value=" Imprimer  " onclick="window.print();"/>
<input type="submit" style="width:80px; height:23px"  name="btn"  class="btn2" value="   Fermer" onclick="window.close();"/>
</form>
<div>
...
<p>Liste des agents <p>
									 ...
									 <?php 
										...
										$requete="select *  from agent_acep ";
										...
										{ 											 
											 ...
											 print " <td>".stripslashes($row["nom"])." </td>";
											 print " <td>".stripslashes($row["prenom"])." </td>";
											 print " <td> ".stripslashes($row["cni"])." </td>";
											 print " <td> ".stripslashes($row["num_acep"])." </td>";
