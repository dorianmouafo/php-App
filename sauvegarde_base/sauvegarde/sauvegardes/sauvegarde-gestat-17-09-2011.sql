...
INSERT INTO `batiment` (`id_bat`, `id_arrond`, `nom_bat`, `etat_bat`) VALUES ('1','1','délégation d\'arrondissement du minjeun',''),
('2','2','délégation régionale','');
...
('7','1','machine à écrire','bon','2011-09-05','0'),
('8','1','ronéo','mauvais','2005-09-02','0'),
...
('13','2','corbeille à ordure','assez bon etat','2011-09-05','0'),
...
INSERT INTO `personnel` (`mat_pers`, `id_cat`, `id_struct`, `id_arrond`, `id_fonct`, `id_type_pers`, `id_grade`, `nom`, `prenom`, `sexe`, `nationalite`, `cni`, `photo`, `telephone`, `ville`, `bp`, `sit_mat`, `e_mail`, `date_embauche`) VALUES ('1','1','5','1','1','1','1','VERRO','claude','M','CAMEROUN','1234567890','RAS','234567890','YAOUNDE','3456','marié','bernadettembazoa@yahoo.fr','2008-07-04'),
('MADFUUI6','1','4','1','3','2','1','Gerard','La true','M','France','2345678','','23456789','PAris','23456789','célibataire','latrue@gmail.com','2007-09-11'),
('MADFUUI9','1','1','1','2','1','3','Eloundou','Nadège','F','Cameroun','1234567890','5.jpg','23456788','YaoundÃƒÂ©','234567890','mariée','magloir@gmail.net','2005-07-25'),
('OMLHNE54','3','3','4','4','2','2','EMANE','Guy Roland','M','Cameroun','23456789','vlcsnap-2011-08-21-02h21m55s81.png','345678998','Douala','2343','célibataire','emane@yahoo.fr','1990-02-06'),
('PNHB','1','5','1','1','1','1','MAyi','Germaine','F','Cameroun','23456789','','23456789','Garoua','23456','célibataire','mayi@voila.cm','2002-05-08');
...
('2','délégation régionale'),
('3','délégation départementale'),
('4','DAG'),
